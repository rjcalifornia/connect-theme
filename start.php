<?php
/**
 * Connect Plus theme plugin
 *
 * @package ConnectTheme
 */

elgg_register_event_handler('init','system','connect_theme_init');

function connect_theme_init() {

	elgg_register_event_handler('pagesetup', 'system', 'connect_theme_pagesetup', 1000);

	// theme specific CSS
	elgg_extend_view('elgg.css', 'connect_theme/css');

	elgg_unextend_view('page/elements/header', 'search/header');
	elgg_extend_view('page/elements/sidebar', 'search/header', 0);
	
	elgg_register_plugin_hook_handler('head', 'page', 'connect_theme_setup_head');
 ...
 */
function connect_theme_pagesetup() {
 ...
 * @return array
 */
function connect_theme_setup_head($hook, $type, $data) {
	...
	$data['links']['apple-touch-icon'] = array(
		...
		'href' => elgg_get_simplecache_url('connect_theme/homescreen.png'),
	);
